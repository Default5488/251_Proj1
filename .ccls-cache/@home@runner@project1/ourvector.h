...
// ourvector<T>
//
template <typename T> class ourvector {
private:
  //
...
//
template <typename T> int ourvector<T>::InUse = 0;

template <typename T> int ourvector<T>::Vectors = 0;

template <typename T> int ourvector<T>::Inserts = 0;

template <typename T> int ourvector<T>::Accesses = 0;
